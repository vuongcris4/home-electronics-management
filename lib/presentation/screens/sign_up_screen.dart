...
// Tương tự, widget _buildInputField giữ nguyên như code gốc của bạn
// ... (Dán code widget helper _buildInputField của bạn vào đây)
  ...
  void _signUp() async {
    ...
    if (success && mounted) {
      Navigator.pushNamedAndRemoveUntil(context, '/signup-success', (route) => false);
       ...
       ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Đăng ký thất bại: ${authProvider.errorMessage}')),
      );
    }
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
          ...
          leading: Padding(
            ...
            child: IconButton(
              icon: const Icon(Icons.arrow_back_ios, color: Color(0xFF14304A), size: 24),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text('Create Account', style: TextStyle(color: Color(0xFF13304A), fontSize: 28, fontFamily: 'Inter', fontWeight: FontWeight.w600, letterSpacing: 0.14), textAlign: TextAlign.center),
              const SizedBox(height: 12),
              const Text('Fill your information below or register\nwith your social account', textAlign: TextAlign.center, style: TextStyle(fontSize: 12, fontWeight: FontWeight.w500, color: Color(0xFFC4C4C4), letterSpacing: 0.06, height: 1.5)),
